...
public class ConexionServidor extends Thread {
	...
	public void run() {
		...
		try {
			...
			JOptionPane
					.showMessageDialog(
							ventanaSubastaVendedor,
							"Ya hay una subasta abierta. \n Por Favor ingresa como cliente.",
							"Error en creaci\u00f3n de Subasta",
			...
			try {
				...
				JOptionPane.showMessageDialog(ventanaSubastaVendedor,
						"CServidor / no se cerró el puerto + e2.getMessage()");
			}
