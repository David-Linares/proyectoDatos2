	...
	public synchronized void run() {
		while (true) {
			try {
				...
				/*
				 * SE CREA UN CLIENTE Y UNA CONEXION QUE SERÀ NOTIFICADA AL
				...
				/*
				 * ENVÌA A LA VENTADA DEL SERVIDOR EL NUEVO OFRECIMIENTO DE UN
				 ...
				 * ENVÌA AL SERVIDOR EL PRODUCTO QUE SE HA SELECCIONADO
				 */
				case 5:
